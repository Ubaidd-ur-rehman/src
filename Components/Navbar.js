...
export default function Navbar(props){
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupport edContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          {/* <a className="nav-link active" aria-current="page" href="www.google.com">{props.Home}</a> */}
          <Link className="nav-link active" aria-current="page" to="/textform">{props.Home}</Link>
        </li> 
        <li className="nav-item">
          {/* <a className="nav-link active" aria-current="page" href="www.google.com">{props.Contact}</a> */}
          <Link className="nav-link active" aria-current="page" to="/about">{props.Contact}</Link>
        </li>
      </ul>
